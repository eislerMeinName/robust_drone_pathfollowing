...
from robust_drone_pathfollowing.spDRL.util.vec_normalize import VecNormalize
from robust_drone_pathfollowing.spDRL.util.parameter_parser import create_override_appendix

from stable_baselines3 import SAC
from stable_baselines3 import PPO
from stable_baselines3.common.vec_env import VecEnv, DummyVecEnv
#from stable_baselines3.common.policies import BasePolicy as MlpPolicy
...
class Learner(Enum):
    ...
    def create_learner(self, env, parameters):
        ...
        if self.trpo():
            ...
            model = PPO('MlpPolicy', env, **parameters["common"], **parameters[str(self)])
